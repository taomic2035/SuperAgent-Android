...
| M4 语音绿 | 09-30 | ◐ | ASR 真机 PASS；TTS BLOCKED（#14 int8 native exit(1)，文件齐全零内存压力，需 native trace）；人评待用户 |
| M5 工程绿 | 09-30 | ◐ | 流水线全绿（brain 17+body 18+契约镜像）、live-glm 过、装机/部署链真机过；TL-04 本报告、并发 ✅（8 路 0s） |
