...
```mermaid
flowchart LR
    Static[静态与契约<br/>typecheck + 34 shared types] --> Host[宿主自动化<br/>brain 25+6 / body 80]
    Host --> Build[APK 构建]
    Build --> Device[真机功能]
...
| body JVM | common + core 共 80 | ✅ 本轮通过 |
...
| M5 工程绿 | 09-30 | ◐ | 当前自动化：brain smoke 25 + integration 6、body 80、契约 34 类型全绿；本轮 APK/真机未复验 |
