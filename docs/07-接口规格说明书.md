...
| BLOB_UNSUPPORTED | 200 | P1 前访问 /blob（GET /blob 已实际返回此码占位） | 等升级 |
| PROTOCOL_MISMATCH | —（brain 本地） | protocolVersion 不符（**brain 侧本地生成；当前 brain 未实现版本校验，见 handoff 差异项**） | 提示升级另一侧 |
